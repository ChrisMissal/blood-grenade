...
# Prefer running ./scripts/setup-github.sh (GitHub CLI) to apply these settings.
#
...
- Required checks:
  ...
  - `Build Example App` (from build.yml)
...
1. Go to: https://github.com/__PROJECT_NAME__/__PROJECT_NAME__/settings/branches
